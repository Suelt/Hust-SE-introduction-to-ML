    ...
    def train(self, training_data,test_data, epoches, batch_size, lr):
        ...
        for j in range(epoches):
            ...
            if test_data:
                ...
                print("Epoch"+str(j)+" :"+"   accuracy:"+str(self.ifprint(test_data)/10000)+"   loss:"+str(loss)) 
...
if __name__ == '__main__':
    ...
    train_data = []
    train_x = x_train.reshape([x_train.shape[0], x_train.shape[1]*x_train.shape[2]]).T
    train_x=train_x/255

  
    test_data = []
    test_x = x_test.reshape([x_test.shape[0], x_test.shape[1]*x_test.shape[2]]).T
    test_x=test_x/255
