...
class NumpyinMnist():
    ...
    def backpropagation(self, x, y):
        ...
        # [10,1] [10,1] ->[10,1]
        delta = intermediate_list[2] * (1 - intermediate_list[2]) * (intermediate_list[2] - y)
        gradient_b[-1] = delta
        # [10,1]@[1,30] -> [10,30]
        # activation:[30,1]
        gradient_w[-1] = np.dot(delta, intermediate_list[-2].T)
        ...
        for l in range(2, self.layers+1):
            ...
            gradient_b[l] = delta
            # [30,1] @ [784,1]T => [30,784]
            gradient_w[l] = np.dot(delta, intermediate_list[l - 1].T)
