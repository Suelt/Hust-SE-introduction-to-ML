...
class MLP():
    ...
    def __init__(self, sizes):
        ...
        for l in range(self.num_layers):
            parameters["W" + str(l+1)] = np.random.randn(self.size[l+1], self.size[l]) * 2.0 / self.size[l]
            parameters["b" + str(l+1)] = np.zeros((self.size[l+1], 1)) + 0.1
...
if __name__ == '__main__':
    ...
    net = MLP([784, 30, 10])
    net.train(train_data, 10, 10, 0.1, test_data=test_data)
